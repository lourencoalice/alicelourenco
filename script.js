...
const translatableSelectors = [
  ...
  '.timeline-card p', '.timeline-card .tags span', '.skills .section-label',
...
const english = {
  ...
  '.nav-links > a': ['About', 'Experience', 'Skills', 'Education', 'Contact'],
  ...
  '.education .section-label': ['Education'], '.education-heading h2': ['Education'],
  '.education-heading > p': ["Alice's education connects her administrative background with the Information Technology field."],
  '.education-list small': ['Degree in progress','Technical education','Course','Course'],
  '.education-list h3': ['Information Technology Management','Technical Program in Administration','Front-End Track','English and Spanish Languages'],
  '.education-list article > p': ['FATEC Guaratinguetá','SENAC Guaratinguetá','Origamid','KNN Idiomas'],
  '.education-year': ['2026 — 2028','2021 — 2022','Present','2024'],
